...
class Executer:
    ...
    def data_of_breaks(self,now_date_start,now_date_end)-> dict:
        ...
        correct_timestamp_dict_2 = {i[1]:(i[0],i[2],-100) for i in self.cur.fetchall()}
    ...
    def data_of_sorted(self,now_date_start,now_date_end):
        ...
        self.cur.execute(f"""SELECT category_id FROM sorted_object 
                         WHERE sorted_timestamp>'{now_date_start}' and sorted_timestamp<'{now_date_end}'""") 
